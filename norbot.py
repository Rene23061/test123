...
def is_group_allowed(chat_id):
    cursor_whitelist.execute("SELECT allow_NoTextBot FROM allowed_groups WHERE chat_id = ? AND allow_NoTextBot = 1", (chat_id,))
...
def main():
    ...
    print("🤖 NoReadBot läuft mit Whitelist-Prüfung...")
